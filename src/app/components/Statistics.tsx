...
<section className="py-24 text-white bg-gradient-to-b from-[#0A0A0A] to-[#1D1841]">
  <div className="container mx-auto px-8 text-center">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="bg-white/10 p-8 rounded-2xl shadow-lg shadow-[#4C1D95]/40 border border-[#5E4A91] hover:scale-105 transition-transform duration-300 backdrop-blur-md">
